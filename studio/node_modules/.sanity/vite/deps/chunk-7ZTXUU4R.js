...
import {
  ...
  usePortal,
  useToast
} from "./chunk-NLKF6RT5.js";
import {
  require_dist
} from "./chunk-PANJJBQA.js";
import {
  AddIcon,
  ArrowLeftIcon,
  CheckmarkCircleIcon,
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-444PPTPC.js")
});
...
var DocumentPaneWithLegacyTimelineStore = (props) => {
  ...
  const store = useTimelineStore(t1), onOlderRevision = useTimelineSelector(store, _temp$5), revTime = useTimelineSelector(store, _temp2$1), sinceAttributes = useTimelineSelector(store, _temp3$1), timelineDisplayed = useTimelineSelector(store, _temp4$1), timelineReady = useTimelineSelector(store, _temp5$1), isPristine = useTimelineSelector(store, _temp6), lastNonDeletedRevId = useTimelineSelector(store, _temp7);
  let t2;
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-4IMXSVWH.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-7ZTXUU4R.js.map
